...
let urls: any = {
	linux: {
		...
		ipfs: 'https://github.com/ipfs/go-ipfs/releases/download/v0.5.1/go-ipfs_v0.5.1_linux-amd64.tar.gz',
	...
	darwin: {
		...
		ipfs: 'https://github.com/ipfs/go-ipfs/releases/download/v0.5.1/go-ipfs_v0.5.1_darwin-amd64.tar.gz',
	...
	win32: {
		...
		ipfs: 'https://github.com/ipfs/go-ipfs/releases/download/v0.5.1/go-ipfs_v0.5.1_windows-amd64.zip',
