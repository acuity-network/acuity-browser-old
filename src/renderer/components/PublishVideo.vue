  ...
  <page>
    ...
    <template slot="body">
      ...
      <div v-show="!publishing">
        <b-field :label="$t('PublishVideo.Title')">
          <b-input v-model="title"></b-input>
        </b-field>

        <b-field :label="$t('PublishVideo.Description')">
          <b-input v-model="description" type="textarea"></b-input>
        </b-field>

        <b-field :label="$t('PublishVideo.Feed')">
          <b-select v-model="feedId" :placeholder="$t('PublishVideo.SelectAFeed')">
            <option
              v-for="feed in feeds"
              :value="feed.itemId"
              :key="feed.itemId">
...
<script lang="ts">
  ...
  export default {
    ...
    async created() {
      setTitle(this.$t('PublishVideo.PublishVideo'))
