...
let urls = {
	linux: {
		parity: 'https://releases.parity.io/ethereum/v2.5.6/x86_64-unknown-linux-gnu/parity',
	...
	darwin: {
		parity: 'https://releases.parity.io/ethereum/v2.5.6/x86_64-apple-darwin/parity',
	...
	win32: {
		parity: 'https://releases.parity.io/ethereum/v2.5.6/x86_64-pc-windows-msvc/parity.exe',
...
try {
	if (parseInt(fs.readFileSync('download_rev')) >= 5) {
		process.exit(0)
	}
} catch (e) {}
...
.then(() => {
	fs.writeFileSync('download_rev', '5')
	process.exit(0)
})
.catch(e => {
